defmodule WorkflowDsl.Http do
  ...
  defp request(:get, %{"url" => url, "headers" => headers} = _params) do
    Req.request(method: :get, url: URI.encode(url), headers: headers)
  end
  defp request(:get, %{"url" => url} = _params) do
    Req.request(method: :get, url: URI.encode(url))
  end
  ...
  defp request(:post, %{"url" => url, "headers" => headers, "body" => body} = _params) do
    ...
    Req.request(method: :post, url: URI.encode(url), headers: headers, body: body)
  end
  defp request(:post, %{"url" => url, "body" => body} = _params) do
    body =
      ...
      |> translate_body(:post)
      |> Jason.encode!()
    Req.request(method: :post, url: URI.encode(url), body: body)
  end
  ...
  defp request(:put, %{"url" => url, "headers" => headers, "body" => body} = _params) do
    ...
    headers =
      headers |> Enum.map(fn [k, v] -> {k, v} end) |> Enum.into(%{})
    Req.request(method: :put, url: URI.encode(url), headers: headers, body: body)
  end
  defp request(:put, %{"url" => url, "body" => body} = _params) do
    body =
      ...
      |> translate_body(:put)
      |> Jason.encode!()
    Req.request(method: :put, url: URI.encode(url), body: body)
  end
  ...
  defp request(:delete, %{"url" => url, "headers" => headers, "body" => body} = _params) do
    ...
    headers =
      headers |> Enum.map(fn [k, v] -> {k, v} end) |> Enum.into(%{})
    Req.request(method: :delete, url: URI.encode(url), headers: headers, body: body)
  end
  defp request(:delete, %{"url" => url, "body" => body} = _params) do
    body =
      ...
      |> translate_body(:put)
      |> Jason.encode!()
    Req.request(method: :delete, url: URI.encode(url), body: body)
  end
